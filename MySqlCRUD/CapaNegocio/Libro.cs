...
namespace MySqlCRUD.CapaNegocio
{
    class Libro : ILibro
    {
        ...
        public bool Agregar(string codLibro, string titulo, string editorial)
        {
            ...
            {
                mysqlCon.Open();
                MySqlCommand mySqlCmd = new MySqlCommand("PAAniadirOEditarLib", mysqlCon);
        ...
        public DataTable Buscar(string texto)
        {
            ...
            {
                mysqlCon.Open();
                MySqlDataAdapter sqlDa = new MySqlDataAdapter("PABuscarLib", mysqlCon);
        ...
        public bool Eliminar(string codLibro)
        {
            ...
            {
                mysqlCon.Open();
                MySqlCommand mySqlCmd = new MySqlCommand("PAEliminarLib", mysqlCon);
                mySqlCmd.CommandType = CommandType.StoredProcedure;
                mySqlCmd.Parameters.AddWithValue("_CodLibro", codLibro);
                mySqlCmd.ExecuteNonQuery();
                Listar();
        ...
        public DataTable Listar()
        {
            ...
            {
                mysqlCon.Open();
                MySqlDataAdapter sqlDa = new MySqlDataAdapter("PAListarLib", mysqlCon);
                sqlDa.SelectCommand.CommandType = CommandType.StoredProcedure;
                DataTable dtblBook = new DataTable();
                sqlDa.Fill(dtblBook);
