...
namespace MySqlCRUD.CapaNegocio
{
    ...
    {
        string connectionString = @"Server=localhost;Database=bdbiblioteca;Uid=root;Pwd=;convert zero datetime=True;";
        ...
        public bool EliminarPrestamo(string FechaPrestamo, string CodLibro, string CodAutor)
        {
            using (MySqlConnection mysqlCon = new MySqlConnection(connectionString))
            {
                mysqlCon.Open();
